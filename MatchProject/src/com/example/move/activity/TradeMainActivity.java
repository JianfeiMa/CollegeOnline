...
import team.yjcollege.matchproject.adapter.IconAdapter;
...
public class TradeMainActivity extends TitleActivity {
...
//		title_right.setVisibility(View.GONE);
		...
		IconAdapter  secondhandadapter = new IconAdapter(myApplication);
		gridView.setAdapter(secondhandadapter);
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				switch (arg2) {
				case 0:
					intent = new Intent(TradeMainActivity.this,
