...
import team.yjcollege.matchproject.customview.GalleryView;

public class ImageAdapter extends BaseAdapter {
	private ImageView[] mImages;		// 保存倒影图片的数组
	private Context mContext;
	public List<Map<String, Object>> list;
	public Integer[] imgs = { R.drawable.yjcollege1, R.drawable.yjcollege2, R.drawable.yjcollege3,
						  R.drawable.yjcollege4, R.drawable.yjcollege5};
	public String[] titles = { "图片01", "图片02", "图片03", "图片04", "图片05", "图片06", "图片07"};
